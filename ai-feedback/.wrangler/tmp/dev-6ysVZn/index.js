...
// src/index.js
var MAX_ANSWER_CHARS = 3e3;
var MAX_RUBRIC_CHARS = 5e3;
var RESPONSE_SCHEMA = {
  type: "object",
  properties: {
    verdict: {
      ...
      description: "strong = captures what the code does and why; partial = right direction but missing or muddling something important; needs_work = misreads what the code does"
    },
    feedback: {
      type: "string",
      description: "2-4 sentences of feedback addressed directly to the student"
    }
  },
  required: ["verdict", "feedback"],
  additionalProperties: false
};
var SYSTEM_PROMPT = `You are a teaching assistant for an introductory policy-school course. Students are learning to READ tidyverse R code \u2014 not write it \u2014 and have been asked to describe in plain English what a piece of code does. You grade their description against a model answer and grading notes.
...
// .wrangler/tmp/bundle-RHPZOz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RHPZOz/middleware-loader.entry.ts
